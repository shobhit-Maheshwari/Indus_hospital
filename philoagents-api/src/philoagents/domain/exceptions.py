...
class PhilosopherEraNotFound(Exception):
    """Exception raised when a philosopher's era is not found."""

    def __init__(self, philosopher_id: str):
        self.message = f"Philosopher era for {philosopher_id} not found."
        super().__init__(self.message)
